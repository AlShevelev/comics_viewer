...
import com.shevelev.comics_viewer.ui.activities.UserActionsManager
import com.shevelev.comics_viewer.ui.activities.comics_creation.SortPagesActivity
import com.shevelev.comics_viewer.ui.activities.folders.ChooseFolderActivity
import com.shevelev.comics_viewer.ui.activities.folders.ChooseFolderActivity.Companion.start
import com.shevelev.comics_viewer.ui.activities.main.bookshelf.BookshelfComicsInfo
import com.shevelev.comics_viewer.ui.activities.main.bookshelf.BookshelfComicsReader
import com.shevelev.comics_viewer.ui.activities.main.bookshelf.comics_control.ComicsContextMenuInfo
import com.shevelev.comics_viewer.ui.activities.main.comics_filters.ComicsFilterFactory.getFilter
import com.shevelev.comics_viewer.ui.activities.main.comics_filters.ComicsViewMode
import com.shevelev.comics_viewer.ui.activities.main.one_comics_working.ComicsWorkingFacade
...
class MainActivity : ActivityBase(), IRheaActivity, IOneComicsActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(view)
        comicsWorkingFacade = ComicsWorkingFacade(this, keyValueStorage)
    ...
    override fun inject(key: String) {
        App.injections.get<MainActivityComponent>(key).inject(this)
    }
    ...
    override fun updateBooksList(idOfComicsToScroll: Long?) {
        val reader = BookshelfComicsReader(this, getFilter(this, keyValueStorage, changeModeHandler!!.viewMode),
            {
